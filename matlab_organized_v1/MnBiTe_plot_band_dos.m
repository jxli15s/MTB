...
hkpoints={[0.333333,0.333333,0.000000],...
          ...
          [0.5,0.0,0.000000]};% hkpoints-high symmetry k points
nk=101;
efermi=0.0258;
...
for i=1:11
    ...
    MTB.plot.plot_bands_Electric(Energy,nbands,efermi,kpath,labels,kindex,"Fig"+num2str(i),Electric_field_in_evpA*10000);
...
%% DOS cals for different Electric_field

load("data/MnBiTe-xu/dos/Enk_all_201-201.mat")
nk=201;
Enum=81;
Emin=-0.05;
Emax=0.05;
...
for i=1:11
    Electric_field_in_evpA=Electric_field_list(i);
    Energy=Enk_all(:,:,:,i);
    % [~,Energy]=MTB.ham.get_bulk_plane_bands_add_electric(g,Electric_field_in_evpA,Kx,Ky,Kz);
