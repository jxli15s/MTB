clear;
clear all;
g = MTB.geometry("Weyl3D");
g = MTB.read_poscar(g,"data/3DWeyl/POSCAR-Weyl");
[g.ham,g.hopr] = MTB.read_hr('data/3DWeyl/Weyl3D_hr.dat');
%% Set K-path
...
hkpoints={[0.5,0.0,0.000000],...
          ...
          [0.0,0.0,0.5000000]};% hkpoints-high symmetry k points
nk=201;
efermi=0.0;
%%
...
knum=501;
x_frac=linspace(-0.5,0.5,knum+1);
y_frac=linspace(-0.5,0.5,knum+1);
...
Kz=ones(knum,knum)*0.161*g.b(3,3);
