function [g, Q, F, v_dirs] = quantum_geometry_general_k(obj, k, dk_list, Uk, Ek, band_index, delta)
...
% 额外输出:
%   v_dirs : Ndir x 1, 目标带在每个方向上的速度 v_i = <n|H_i|n>
    ...
    for a = 1:Ndir
        ...
        % 目标带在此方向上的 "速度"：v_a ∝ <n|H_a|n>
        v_dirs(a) = real( u0' * H_a * u0 );   % 是否除以 ħ，看你整体单位约定
    end
